      ...
      <main>
        ...
        <Alert variant="danger">
          ...
          <p>
            ...
            system is designed to streamline every step of the delivery journey.
            From order processing to final destination, our platform offers
            unparalleled visibility and control, allowing businesses to make
            informed decisions and drive greater operational success. We believe
            in the power of technology to transform industries, and our team is
            dedicated to staying at the forefront of innovation. With
            cutting-edge features and continuous updates, we're committed to
            providing our clients with the most advanced delivery management
            solution on the market. At DeliverEasy, we're more than just a
            software provider – we're your partner in success. Join us on our
            journey to redefine delivery management and unlock new possibilities
            for your business.
          </p>
        </Alert>
